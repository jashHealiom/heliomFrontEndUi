...
const SpecialistCard = props => {
    ...
    return (
        <TouchableOpacity style={[style, { marginBottom: 10 }]} activeOpacity={0.99} onPress={onPress}>
            <Card style={[{
                shadowColor: "#000",
                shadowOffset: {
                    width: 0,
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'flex-start' }}>
                    <Image style={{ height: 65, width: 65, borderRadius: 50, }} source={source} />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 5, paddingHorizontal: 5 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start' }}>
                        ...
                        <Text style={{ fontSize: 18, marginLeft: 30, marginTop: 4, fontFamily: 'Rubik', color: 'black' }}>{rating}</Text>
                    </View>
                    <View>
                        <Text style={{ fontSize: 18, marginLeft: 20, marginTop: 4, fontFamily: 'Rubik', color: 'black' }}>{ratePerHour}</Text>
                    </View>
                </View>
            </Card>
        </TouchableOpacity>
