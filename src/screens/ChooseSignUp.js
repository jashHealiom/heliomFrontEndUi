...
const ChooseSignUp = ({navigation}) => {
  return (
    <View style={styles.mainContainer}>
      <View style={styles.backArrowContainerChooseSignUp}>
      ...
      <TouchableOpacity
        ...
        <Image style={styles.roleImage} source={images.roleChoosePatient} />
      ...
      <TouchableOpacity
        ...
        <Image style={styles.roleImage} source={images.roleChooseProvider} />
